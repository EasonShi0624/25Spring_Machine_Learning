...
def train_vae_recon_only(model, train_loader, val_loader, optimizer, device,
    ...
    for epoch in range(1, num_epochs+1):
        ...
        # Save checkpoint
        ckpt_dir="/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/nb_model/checkpoint"
        torch.save(model.state_dict(), f"{ckpt_dir}/new_resblock_checkpoint_epoch{epoch}.pt")
