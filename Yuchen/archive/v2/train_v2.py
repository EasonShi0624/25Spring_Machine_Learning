...
if __name__ == "__main__":
    ...
    train_vae(model, train_loader, val_loader, optimizer, device,
              num_epochs=30, beta_max=0.1, alpha=0.001)

    # Save model weights
    torch.save(model.state_dict(), "/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v2/checkpoint/checkpoint_leaky.pt")
