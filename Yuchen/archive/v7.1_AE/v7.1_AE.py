...
def train_ae_recon_only(model, train_loader, val_loader, optimizer, device,
                       num_epochs=50):
    model.to(device)
    ...
    for epoch in range(1, num_epochs+1):
        ...
        ckpt_dir = "/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v7.1_AE/checkpoint"
        torch.save(model.state_dict(), f"{ckpt_dir}/feature_refine_new_atten_checkpoint_epoch{epoch}.pt")
