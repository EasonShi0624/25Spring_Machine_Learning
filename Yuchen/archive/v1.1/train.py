...
class ConvVAE(nn.Module):
    def __init__(self, input_channels=3, latent_channels=4, num_classes=10):
        super().__init__()
...
# --- Training Loop with ��-Annealing, Joint Classification & Validation ---
...
if __name__ == "__main__":
    ...
    train_vae(model, train_loader, val_loader, optimizer, device,
              num_epochs=30, beta_max=0.1, alpha=1000)

    # Save model weights
    torch.save(model.state_dict(), "/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v1/checkpoint/checkpoint.pt")
