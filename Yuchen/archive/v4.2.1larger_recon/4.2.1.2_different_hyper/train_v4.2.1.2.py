...
def train_vae(model, train_loader, val_loader, optimizer, device,
    ...
    for epoch in range(1, num_epochs+1):
        ...
        ckpt_name = f"/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v4.2.1larger_recon/4.2.1.2_different_hyper/checkpoint_difhyper/checkpoint_beta0.2_epoch{epoch}.pt"
