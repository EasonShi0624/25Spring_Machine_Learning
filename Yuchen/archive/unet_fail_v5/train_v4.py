...
def train_vae(model, train_loader, val_loader, optimizer, device,
    ...
    for epoch in range(1, num_epochs+1):
        ...
        ckpt_name = f"/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v5/checkpoint/checkpoint_epoch{epoch}.pt"
...
if __name__ == "__main__":
    ...
    train_vae(
        ...
        delta=10        # perceptual loss weight
    )
