...
"""
python train_v4_SiLU_tuning_continue.py --resume /gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v4_SiLU_8latent_tuning/checkpoint/checkpoint_epoch350.pt
"""
...
def train_vae(model, train_loader, val_loader, optimizer, device,
    ...
    for epoch in range(start_epoch, num_epochs + start_epoch):
        ...
        ckpt_dir = "/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v4.1_SiLU_continue/checkpoint"
        ckpt_dict = {
            "epoch": epoch,
