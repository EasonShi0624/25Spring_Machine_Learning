...
def train_vae(model, train_loader, val_loader, optimizer, device,
              ...
              vgg=None, imagenet_mean=None, imagenet_std=None, delta=0.01, save_ckpt: bool = True):
    model.to(device)
    ...
    for epoch in range(1, num_epochs+1):
        ...
        if save_ckpt:
            ckpt_name = f"/gpfsnyu/scratch/ys6132/25spring_machine_learning/Yuchen/v4_SiLU_8latent_8×32×32/checkpoint/8*32*32_checkpoint_SiLU_epoch{epoch}.pt"
